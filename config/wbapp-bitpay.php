...
return [
     ...
     * The default value is /tmp/wbapp-bitpay.pri
     */
    'private_key' => env('BITPAY_PRIVATE_KEY_PATH', '/tmp/wbapp-bitpay.pri'),

    /*
     * This is the full path and name for the public key.
     * The default value is /tmp/wbapp-bitpay.pub
     */
    'public_key' => env('BITPAY_PUBLIC_KEY_PATH', '/tmp/wbapp-bitpay.pub'),
