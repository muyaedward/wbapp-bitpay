...
namespace Muyaedward\WbappBitpay\Commands;
...
use Muyaedward\WbappBitpay\Traits\CreateKeypairTrait;
...
class CreateKeypair extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wbapp-bitpay:createkeypair { pairingcode : Pairing code created on BitPay server.}';
    ...
    public function handle()
    {
        ...
        $this->laravel['config']['wbapp-bitpay.token'] = $this->token;
